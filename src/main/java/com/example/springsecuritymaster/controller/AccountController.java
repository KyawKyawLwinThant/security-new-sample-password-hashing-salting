...
public class AccountController {
    ...
    @PostMapping("/signup")
    public String saveSignup(@ModelAttribute("user") @Valid RegisterUser user
    ...
    private void storeSecurityContextDataInModel(String prefix, Model model){
        ...
        model.addAttribute(prefix+"HashCode"
                ,Integer.toHexString(securityContext.hashCode()));
        ...
        model.addAttribute(prefix+"Username",
                Optional.ofNullable(user)
                        .map(User::getUsername)
                        .orElse("N/A"));

        model.addAttribute(prefix+"Authorities",
                Optional.ofNullable(authentication)
